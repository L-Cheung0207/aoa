...
export interface SettingsText {
  ...
  options: {
    ...
    translationTargets: readonly SettingsOption<
      AppSettings["translation"]["targetLanguage"]
    >[];
...
const SETTINGS_TEXT: Record<InterfaceLanguage, SettingsText> = {
  ...
  "en-US": {
    ...
    header: {
      title: "Settings",
      subtitle:
        "Settings are stored on this device and are not uploaded to the cloud.",
    },
    sections: {
    ...
    shortcuts: {
      ...
      smartRewriteDescription:
        "Process selected text with spoken instructions.",
      translate: "Translate",
    ...
    language: {
      ...
      interfaceLanguageDescription:
        "Choose the language used by the user interface.",
      translationTarget: "Translation Target",
      translationTargetDescription:
        "Choose the output language for translation mode.",
    },
    audio: {
      microphone: "Microphone",
      microphoneDescription:
        "Choose your preferred microphone for Typeless to capture your voice.",
      interactionSounds: "Interaction Sounds",
      interactionSoundsDescription:
        "Play sounds for key actions such as start and stop.",
      muteDuringVoiceInput: "Mute During Voice Input",
      muteDuringVoiceInputDescription:
        "Automatically mute other active audio during voice input.",
      recognitionLanguage: "Recognition Language",
      recognitionLanguageDescription:
        "Controls the language hint used for speech recognition.",
      waveformEffect: "Waveform Effect",
      waveformEffectDescription:
        "Choose the waveform style for the floating window.",
      waveformPreview: "Waveform effect preview",
    },
    appBehavior: {
      launchAtLogin: "Launch at Login",
      launchAtLoginDescription:
        "Open Typeless automatically when your computer starts.",
    },
    connection: {
